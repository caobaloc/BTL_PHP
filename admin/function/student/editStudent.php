        ...
        <main>
            <div>
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <table class="button-add">
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="../../uploads/anhtruoc/<?php if ($student_id) echo $result['anh_mat_truoc']; ?>" alt="" style="width: 150px; height:150px; ">
                                <input type="file" name="anhtruoc">
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <img src="../../uploads/anhsau/<?php if ($student_id) echo $result['anh_mat_sau']; ?>" alt="" style="width: 150px; height:150px; ">
                                <input type="file" name="anhsau">
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <img src="../../uploads/anhchandung/<?php if ($student_id) echo $result['anh_chan_dung']; ?>" alt="" style="width: 150px; height:150px; ">
                                <input type="file" name="anhchandung">
                            </td>
                        </tr>
                        <tr>
                ...
                if (isset($_POST['btn-edit-student'])) {
                    ...
                    // var_dump(move_uploaded_file($anhtruocfile_tmp, $path . $anhtruocfile));
                    // die();
